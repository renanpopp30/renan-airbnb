        ...
        {photos.map((photo) => (
          <div className="relative">
            ...
            <div className="absolute flex right-2 bottom-2 gap-1">
              <div onClick={() => promotePhoto(photo)} className="hover:bg-primary-400 cursor-pointer rounded-full bg-gray-100 p-2 opacity-75 transition hover:text-white">
                <svg
              ...
              <div onClick={() => deletePhoto(photo)} className="hover:bg-primary-400 cursor-pointer rounded-full bg-gray-100 p-2 opacity-75 transition hover:text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
